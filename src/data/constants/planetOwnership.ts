...
export interface CitadelLevelBenefit {
  ...
  cargoStorage: boolean; // false until Level 2
  repairEnabled: boolean; // false until Level 3
}
...
// cargo storage. Level 3: adds the repair benefit
// (ship.md's resolveComponentRepair(), CITADEL_LEVEL_3_REPAIR_RATE).
