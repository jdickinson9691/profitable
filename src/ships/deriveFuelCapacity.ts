...
// reimplemented inline anywhere fuel capacity is needed. Never called for
// the starting ship's initial values (those are set directly to
// STARTING_SHIP_FUEL_CAPACITY, bypassing this lookup) -- see ship.md's own
// Must-Not-Do.
