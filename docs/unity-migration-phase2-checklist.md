...
- [ ] **Presentation.** Build the Unity equivalent of the combat-choice UI (attack/flee) and the pending-combat indicator wherever this migration's own Ships/Travel presentation (Agent 56's `ShipsPanel`) surfaces it.
