...
- **Confirmed still absent, all pre-existing documented scope cuts, not new gaps**: ship component crafting, ship assembly/component-swap UI, ~~the debug/tuning panel~~ (**resolved 2026-08-08**, see below), won-combat return-voyage UI.
