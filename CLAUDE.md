...
Current verified counts: `dotnet test` 748/748, `npm test` 688/688, Unity EditMode 82/82, Unity PlayMode 6/6 (stable across repeated runs). The existing web/Electron build is confirmed completely unmodified by all Unity migration work, verified via a full diff across every Unity-tagged commit.
